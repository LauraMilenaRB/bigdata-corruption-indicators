...
## Video de resumen
[![Video de youtube](http://img.youtube.com/vi/aN7xFw2ZJv4/0.jpg)](http://www.youtube.com/watch?v=aN7xFw2ZJv4 "Video Title")
       ...
       1. Para configurar el DAG, edité los siguientes archivos:
          ...
          * **vars_emr_jobs.py:** Contiene las variables requeridas para el DAG.
            ...
            4. <br>![img_19.png](img/img_19.png)<br>
               * **endpoint_conn_arg:** El host para conectarse a la base de datos de Amazon Redshift. Para ello busque el servicio Amazon Redshift, seleccione el cluster y en ***'Información general'*** copie el ***'Punto de enlace'*** sin puerto y nombre de bd como se muestra en la imagen: 
